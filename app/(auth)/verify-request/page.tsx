    ...
    <Card className="w-full mx-auto">
      <CardHeader className="text-center">
        ...
        <CardDescription>
          ...
          open th email and paste the code below.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div className="flex flex-col items-center space-y-2 ">
          <InputOTP
            ...
            maxLength={6}
            containerClassName="group flex items-center has-[:disabled]:opacity-50 gap-2"
          >
            <InputOTPGroup>
          ...
          <p className="text-sm text-muted-foreground">
            Enter the 6-digit code sent to yours email
          </p>
        </div>
